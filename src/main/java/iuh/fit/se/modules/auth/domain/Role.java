...
public enum Role {
    ...
    STAFF_SELLER(EnumSet.of(
        ...
        INVENTORY_READ, INVENTORY_VIEW_HISTORY, STOCK_REQUEST_CREATE, STOCK_REQUEST_READ_ALL,
        RETURN_READ_ALL, RETURN_APPROVE,
        DASHBOARD_REVENUE
    )),
    ...
    STAFF_WAREHOUSE(EnumSet.of(
        ...
        STOCK_REQUEST_CREATE, STOCK_REQUEST_APPROVE, STOCK_REQUEST_READ_ALL,
        DASHBOARD_INVENTORY
    )),
