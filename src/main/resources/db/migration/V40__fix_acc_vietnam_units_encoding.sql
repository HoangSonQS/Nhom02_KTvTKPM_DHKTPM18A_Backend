-- V40: Fix double-encoded UTF-8 in Vietnamese administrative unit names.
-- The original V33 migration had mojibake data.
-- This migration deletes and re-inserts all data with correct UTF-8 encoding.

-- Clear old data (wards first due to FK)
DELETE FROM acc_wards;
DELETE FROM acc_provinces;
